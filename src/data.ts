...
export function getDefaultHumanResources(): TechnicienResource[] {
  return [
    {
      id: "hr_tech_sr",
      nom: "Tech Mécanique SR",
      displayName: "Tech Mécanique SR",
      specialite: "Mécanique Rapide",
      disponibilite: "disponible",
      compétences: ["Vidange", "Freinage"],
      zoneAffectee: AtelierZone.MECANIQUE_RAPIDE,
      absencesConges: [],
      capaciteJournaliere: 8,
      chargeActuelle: 0,
      ...
      planifiable: true,
      type: "HUMAN",
      metierPrincipal: AtelierMetier.MECANIQUE_RAPIDE,
      metiersSecondaires: [],
      capaciteJournaliereMinutes: 480,
      linkedUserId: "user_technicien",
    },
    {
      id: "hr_tech_gt",
      nom: "Tech Mécanique GT",
      displayName: "Tech Mécanique GT",
      specialite: "Grands Travaux Mécaniques",
      disponibilite: "disponible",
      compétences: ["Moteur", "Embrayage"],
      zoneAffectee: AtelierZone.GRANDS_TRAVAUX,
      absencesConges: [],
      capaciteJournaliere: 8,
      chargeActuelle: 0,
      ...
      planifiable: true,
      type: "HUMAN",
      metierPrincipal: AtelierMetier.MECANIQUE_GRAND_TRAVAUX,
      metiersSecondaires: [],
      capaciteJournaliereMinutes: 480,
    },
    {
      id: "hr_tech_elec",
      nom: "Tech Électricité",
      displayName: "Tech Électricité",
      specialite: "Diagnostic Électrique / Hybride",
      disponibilite: "disponible",
      compétences: ["OBD", "Batterie"],
      zoneAffectee: AtelierZone.ELECTRICITE_DIAG,
      absencesConges: [],
      capaciteJournaliere: 8,
      chargeActuelle: 0,
      ...
      planifiable: true,
      type: "HUMAN",
      metierPrincipal: AtelierMetier.ELECTRICITE_DIAGNOSTIC,
      metiersSecondaires: [],
      capaciteJournaliereMinutes: 480,
    },
    {
      id: "hr_tech_tole",
      nom: "Tech Tôlerie",
      displayName: "Tech Tôlerie",
      specialite: "Tôlerie & Carrosserie",
      disponibilite: "disponible",
      compétences: ["Redressage", "Soudure"],
      zoneAffectee: AtelierZone.CARROSSERIE,
      absencesConges: [],
      capaciteJournaliere: 8,
      chargeActuelle: 0,
      ...
      planifiable: true,
      type: "HUMAN",
      metierPrincipal: AtelierMetier.TOLERIE,
      metiersSecondaires: [],
      capaciteJournaliereMinutes: 480,
    },
    {
      id: "hr_tech_peint",
      nom: "Tech Peinture",
      displayName: "Tech Peinture",
      specialite: "Peinture automobile",
      disponibilite: "disponible",
      compétences: ["Pistolet", "Mélange"],
      zoneAffectee: AtelierZone.PEINTURE,
      absencesConges: [],
      capaciteJournaliere: 8,
      chargeActuelle: 0,
      ...
      metiersSecondaires: [AtelierMetier.PREPARATION_PEINTURE],
      capaciteJournaliereMinutes: 480,
    },
    {
      id: "hr_tech_qc",
      nom: "Contrôleur QC",
      displayName: "Contrôleur QC",
      specialite: "Contrôle Qualité",
      disponibilite: "disponible",
      compétences: ["Essai routier", "Checklist"],
      zoneAffectee: AtelierZone.CONTROLE_QUALITE,
      absencesConges: [],
      capaciteJournaliere: 8,
      chargeActuelle: 0,
      actif: true,
      planifiable: true,
      type: "HUMAN",
      metierPrincipal: AtelierMetier.QC,
      metiersSecondaires: [],
      capaciteJournaliereMinutes: 480,
    },
    {
      id: "hr_tech_livr",
      nom: "Agent Livraison",
      displayName: "Agent Livraison",
      specialite: "Lavage & Restitution",
      disponibilite: "disponible",
      compétences: ["Nettoyage", "Restitution"],
      zoneAffectee: AtelierZone.LAVAGE_FINITION,
      absencesConges: [],
      capaciteJournaliere: 8,
      chargeActuelle: 0,
      actif: true,
      planifiable: true,
      type: "HUMAN",
      metierPrincipal: AtelierMetier.LIVRAISON,
      metiersSecondaires: [AtelierMetier.LAVAGE_PREPARATION],
      capaciteJournaliereMinutes: 480,
    }
  ];
}

export function getDefaultMaterialResources(): WorkshopBay[] {
  return [
    {
      id: "bay_fast_01",
      name: "Pont SR 1",
      nom: "Pont SR 1",
      zone: AtelierZone.MECANIQUE_RAPIDE,
      type: "MATERIAL",
      categorie: MaterialCategory.PONT_SERVICE_RAPIDE,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["quick-service", "oilService"],
      compatibleMetiers: [AtelierMetier.MECANIQUE_RAPIDE],
      localisation: "Zone SR, Allée A",
    },
    {
      id: "bay_fast_02",
      name: "Pont SR 2",
      ...
      compatibleTaskTypes: ["quick-service", "oilService"],
      compatibleMetiers: [AtelierMetier.MECANIQUE_RAPIDE],
      localisation: "Zone SR, Allée B",
    },
    {
      id: "bay_mech_01",
      name: "Pont GT 1",
      nom: "Pont GT 1",
      zone: AtelierZone.GRANDS_TRAVAUX,
      type: "MATERIAL",
      categorie: MaterialCategory.PONT_GRAND_TRAVAUX,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["mechanical"],
      compatibleMetiers: [AtelierMetier.MECANIQUE_GRAND_TRAVAUX],
      localisation: "Zone GT, Allée C",
    },
    {
      id: "bay_mech_02",
      name: "Pont GT 2",
    ...
    },
    {
      ...
      zone: AtelierZone.MECANIQUE_RAPIDE,
      type: "MATERIAL",
      categorie: MaterialCategory.PONT_MOBILE,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["quick-service", "oilService", "mechanical"],
      compatibleMetiers: [AtelierMetier.MECANIQUE_RAPIDE, AtelierMetier.MECANIQUE_GRAND_TRAVAUX],
      localisation: "Zone Mobile, Allée E",
    },
    {
      id: "bay_diag_01",
      name: "Zone Diag Électrique",
      nom: "Zone Diag Électrique",
      zone: AtelierZone.ELECTRICITE_DIAG,
      type: "MATERIAL",
      categorie: MaterialCategory.ZONE_DIAGNOSTIC_ELECTRIQUE,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["electrical", "diagnostic"],
      compatibleMetiers: [AtelierMetier.ELECTRICITE_DIAGNOSTIC],
      localisation: "Zone Diagnostic",
    },
    {
      id: "bay_rep_elec_01",
      name: "Zone Réparation Électrique",
      nom: "Zone Réparation Électrique",
      zone: AtelierZone.ELECTRICITE_DIAG,
      type: "MATERIAL",
      categorie: MaterialCategory.ZONE_REPARATION_ELECTRIQUE,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["electrical"],
      compatibleMetiers: [AtelierMetier.ELECTRICITE_DIAGNOSTIC],
      localisation: "Zone Électrique 2",
    },
    {
      id: "bay_prep_01",
      name: "Zone Préparation",
      nom: "Zone Préparation",
      zone: AtelierZone.PREPARATION,
      type: "MATERIAL",
      categorie: MaterialCategory.ZONE_PREPARATION_CARROSSERIE,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["prep", "preparation"],
      compatibleMetiers: [AtelierMetier.PREPARATION_PEINTURE, AtelierMetier.TOLERIE],
      localisation: "Zone Carrosserie - Préparation",
    },
    {
      id: "bay_tole_01",
      name: "Zone Tôlerie",
      nom: "Zone Tôlerie",
      zone: AtelierZone.CARROSSERIE,
      type: "MATERIAL",
      categorie: MaterialCategory.ZONE_TOLERIE,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["body", "body-disassembly", "reassembly"],
      compatibleMetiers: [AtelierMetier.TOLERIE],
      localisation: "Zone Tôlerie 1",
    },
    {
      id: "bay_paint_01",
      name: "Cabine Peinture 1",
      nom: "Cabine Peinture 1",
      zone: AtelierZone.PEINTURE,
      type: "MATERIAL",
      categorie: MaterialCategory.CABINE_PEINTURE,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["paint"],
      compatibleMetiers: [AtelierMetier.PEINTURE],
      localisation: "Zone Peinture - Cabine 1",
    },
    {
      id: "bay_wash_01",
      name: "Zone Lavage",
      nom: "Zone Lavage",
      zone: AtelierZone.LAVAGE_FINITION,
      type: "MATERIAL",
      categorie: MaterialCategory.ZONE_LAVAGE,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["finish"],
      compatibleMetiers: [AtelierMetier.LAVAGE_PREPARATION],
    ...
    },
    {
      ...
      name: "Zone QC",
      nom: "Zone QC",
      zone: AtelierZone.CONTROLE_QUALITE,
      type: "MATERIAL",
      categorie: MaterialCategory.ZONE_QC,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["quality"],
      compatibleMetiers: [AtelierMetier.QC],
      localisation: "Zone Contrôle Qualité",
    },
    {
      id: "bay_delivery_01",
      name: "Zone Livraison",
      ...
      zone: AtelierZone.LAVAGE_FINITION,
      type: "MATERIAL",
      categorie: MaterialCategory.ZONE_LIVRAISON,
      actif: true,
      planifiable: true,
      capaciteVehicules: 1,
      compatibleTaskTypes: ["delivery"],
      compatibleMetiers: [AtelierMetier.LIVRAISON],
      localisation: "Zone Livraison",
    }
  ];
}
